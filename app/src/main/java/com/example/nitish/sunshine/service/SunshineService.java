package com.example.nitish.sunshine.service;
...
import com.example.nitish.sunshine.R;
...
/**
 * Created by nitish on 5/10/14.
 */
public class SunshineService extends IntentService {

    final String LOG_TAG = SunshineService.class.getSimpleName();
    ...
    private long addLocation(String locationSetting, String cityName, double lat, double lon) {
        ...
        Cursor cursor = getContentResolver().query(
                ...
                WeatherContract.LocationEntry.COLUMN_PINCODE + " = ?",
        ...
        if (cursor.moveToFirst()) {
            ...
            locationValues.put(WeatherContract.LocationEntry.COLUMN_PINCODE, locationSetting);
            locationValues.put(WeatherContract.LocationEntry.COLUMN_CITY_NAME, cityName);
            locationValues.put(WeatherContract.LocationEntry.COLUMN_LAT, lat);
            locationValues.put(WeatherContract.LocationEntry.COLUMN_LNG, lon);
...
// you ever want to remove it.
    ...
    public static class AlarmReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            i.putExtra(SunshineService.LOCATION_QUERY_EXTRA, intent.getStringExtra(SunshineService.LOCATION_QUERY_EXTRA));
